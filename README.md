...
# 💻 Language and tools:
[![My Skills](https://skillicons.dev/icons?i=cpp,java,html,css,js,maven,nodejs,mysql,react,sass,ubuntu,vscode,figma,linux,git,idea,sublime,notion&perline=15)](https://skillicons.dev)
